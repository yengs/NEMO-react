            ...
            <div className="itemcontainer">
                ...
                <form id="frm" name="frm">
                    ...
                    <table className="board_detail">
                        ...
                        <tr>
                            <td>대여시작일</td>
                            <td><DatePicker dateFormat="yyyy-MM-dd" className="startDate" selected={startDate} onChange={date => setStartDate(date)} selectStart startDate={startDate} endDate={endDate} locale={ko} minDate={now.setDate(now.getDate() -1)} required /> </td>
                        </tr>
                        <tr>
                            <td>대여마감일</td>
