                    ...
                    <table className="myreviewdetail">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <th scope="row">내용</th>
                                    <textarea title="내용" id="reviewContents" name="reviewContents" value={reviewContents} onChange={handlerChangeContents} ></textarea>
                                </td>
                            </tr>
                            <th>
                                <th scope="row">평점</th>
                                <td><input type='number' id="reviewSatisfaction" name="reviewSatisfaction" value={reviewSatisfaction}
                                    onChange={handlerChangeSatisfaction}></input></td>
                            </th>
                        </tbody>
                    </table>
                </form>
